...
class RiwayatSewaPolicy
{
    ...
    {
        return $user->can('view_any_riwayat::sewa');
    }
    ...
    {
        return $user->can('view_riwayat::sewa');
    }
    ...
    {
        return $user->can('create_riwayat::sewa');
    }
    ...
    {
        return $user->can('update_riwayat::sewa');
    }
    ...
    {
        return $user->can('delete_riwayat::sewa');
    }
    ...
    {
        return $user->can('delete_any_riwayat::sewa');
    }
